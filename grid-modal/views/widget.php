...
<?php foreach ($items as $i => $item) :
        ...
        //Modal instantiancing
        $modals[] = array();
        $modals[$i]['id'] = substr(uniqid(), -3);
        $modals[$i]['title'] = $item['title'];
        $modals[$i]['content'] = $item ['content'];
        ...
        if ($item['link']) {
            ...
            if ($settings['panel_link']) {
                ...
                $overlay = '<a class="{wk}-position-cover" href="' . '#modal-'.$modals[$i]['id']/*$item->escape('link')*/ . '" title="' . $item->escape('title') . '"></a>';
    ...
    <div<?php echo $filter; ?>>
        <div class="<?php echo $panel[$i % 2]; ?><?php echo $panel_hover; ?><?php if ($settings['animation'] != 'none') echo ' {wk}-invisible'; ?>">
            ...
            <a class="{wk}-position-cover {wk}-position-z-index" href="<?php echo '#modal-'.$modals[$i]['id']/*$item->escape('link')*/; ?>"<?php /*echo $link_target;*/ ?> title="<?php echo $item->escape('title'); ?>" uk-toggle></a>
            <?php endif; ?>
            ...
            <div class="{wk}-margin"><?php echo substr(strip_tags($item['content']), 0, 150); ?></div>
            <?php endif; ?>
            ...
            <p><a<?php if($link_style) echo ' class="' . $link_style . '"'; ?> href="<?php echo '#modal-'.$modals[$i]['id'];/*$item->escape('link')*/ ?>"<?php //echo $link_target; ?>><?php echo $app['translator']->trans($settings['link_text']); ?></a></p>
            <?php endif; ?>
...
<div id="modal-<?php echo $modal['id']; ?>" uk-modal>
    <div class="uk-modal-dialog uk-modal-body">
    <h2 class="uk-modal-title"><?php echo $modal['title']; ?></h2>
