...
return array(
    ...
    'config' => array(
        ...
        'label' => 'Grid Modal',
        'core'  => false,
        'icon'  => 'plugins/widgets/grid-modal/widget.svg',
        'view'  => 'plugins/widgets/grid-modal/views/widget.php',
    ...
    'events' => array(
        ...
        'init.admin' => function($event, $app) {
            $app['angular']->addTemplate('grid-modal.edit', 'plugins/widgets/grid-modal/views/edit.php', true);
        }
