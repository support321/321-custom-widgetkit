...
return array(
    ...
    'config' => array(
        ...
        'core'  => false,
        'icon'  => 'plugins/widgets/gallery-overlay/widget.svg',
        'view'  => 'plugins/widgets/gallery-overlay/views/widget.php',
    ...
    'events' => array(
        ...
        'init.admin' => function($event, $app) {
            $app['angular']->addTemplate('gallery-overlay.edit', 'plugins/widgets/gallery-overlay/views/edit.php', true);
        }
