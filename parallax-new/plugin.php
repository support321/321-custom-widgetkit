...
return array(
    ...
    'config' => array(
        ...
        'label' => 'Parallax new',
        'core'  => false,
        'icon'  => 'plugins/widgets/parallax-new/widget.svg',
        'view'  => 'plugins/widgets/parallax-new/views/widget.php',
    ...
    'events' => array(
        ...
        'init.admin' => function($event, $app) {
            $app['angular']->addTemplate('parallax-new.edit', 'plugins/widgets/parallax-new/views/edit.php', true);
        }
