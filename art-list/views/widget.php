...
<?php foreach ($items as $i => $item) :
        ...
        switch ($settings['title_size']) {
            ...
            case 'h5':
            case 'h6':
                $title = '<h3 class="uk-'. $settings['title_size'] .' {wk}-margin-remove">' . $title . '</h3>';
                break;
        }
    ...
    <li>
        ...
        <?php endif; ?>
            ...
            <div class="{wk}-flex <?php echo $content_align; ?>">
                ...
                <div><small><?php echo JText::sprintf('COM_CONTENT_CREATED_DATE_ON', JHtml::_('date', $this->item->created, JText::_('DATE_FORMAT_LC3'))); ?></small></div>
